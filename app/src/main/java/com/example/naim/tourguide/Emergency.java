...
public class Emergency extends AppCompatActivity {
    ...
    private CollectionReference emerRef;
    String emer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            emer = getIntent().getStringExtra("emergency");
            setTitle(emer);
        }
        emerRef=db.collection(emer);
        setUpRecyclerView();

    }

    private void setUpRecyclerView() {
        com.google.firebase.firestore.Query query = emerRef.orderBy("id", com.google.firebase.firestore.Query.Direction.ASCENDING);
        ...
        adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void OnItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent detailintent = new Intent(Emergency.this,Details.class);
