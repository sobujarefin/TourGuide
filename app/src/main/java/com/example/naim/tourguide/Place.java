...
public class Place extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeRef=db.collection(place);
        setUpRecyclerView();
    }

    private void setUpRecyclerView() {
        com.google.firebase.firestore.Query query = placeRef.orderBy("id", com.google.firebase.firestore.Query.Direction.ASCENDING);
        ...
        adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void OnItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent detailintent = new Intent(Place.this,Details.class);
